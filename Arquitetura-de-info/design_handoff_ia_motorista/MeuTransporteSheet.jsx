...
import { semHorarioCombinado } from '../../services/horariosService';
...
export default function MeuTransporteSheet({
  ...
  const semHorario = semHorarioCombinado(children).length;
      ...
      <div className="space-y-4 pb-2">
        <Grupo titulo="quem anda na perua">
          <Linha
            icon={Users}
            titulo="Minha turma"
            contagem={children.length}
            onClick={() => ir('/tio/children')}
          />
          <Linha
            icon={School}
            titulo="Escolas"
            contagem={escolas.length}
